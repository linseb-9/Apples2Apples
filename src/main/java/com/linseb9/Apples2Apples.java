...
public class Apples2Apples {
    ...
    public Apples2Apples(int numberOfOnlinePlayers) throws Exception {
        ...
        redApples = new ArrayList<String>(Files.readAllLines(Paths.get("./", "/src/main/resources/data/redApples.txt"), StandardCharsets.ISO_8859_1));
        greenApples = new ArrayList<String>(Files.readAllLines(Paths.get("./", "/src/main/resources/data/greenApples.txt"), StandardCharsets.ISO_8859_1));
